      ...
      <Content>
        ...
        <Column>
          ...
          <ul>
            ...
            <li>
              {' '}
              <a href="mailto:contact@littlelemon.com" target="_blank" rel="external">
        ...
        <Column>
          ...
          <ul>
            <li>
              {' '}
              <a href="https://www.facebook.com/littlelemon" target="_blank" rel="external">
                Facebook
              </a>{' '}
            </li>
            <li>
              {' '}
              <a href="https://www.instagram.com/littlelemon" target="_blank" rel="external">
                Instagram
              </a>{' '}
            </li>
            <li>
              {' '}
              <a href="https://twitter.com/littlelemon" target="_blank" rel="external">
                Twitter
              </a>{' '}
            </li>
          </ul>
